...
summary = summarizer(meeting_transcript, max_length=150, min_length=30, do_sample=False)[0]['summary_text']
...
while True:
    ...
    response = requests.post(
        ...
        json={
            ...
            'prompt': '\n'.join(conversation_history),  # Use the conversation history as the prompt
            'max_tokens': 50,  # Adjust the max tokens as per your requirements
        }
    )
